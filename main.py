...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, Center.XCenter('─════════════════════════════[ 𝗣𝗟𝗔𝗬𝗘𝗥 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡 ]════════════════════════════─')))
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.rainbow, Center.XCenter('─═════════════════════[ 𝗟𝗢𝗖𝗔𝗧𝗜𝗢𝗡 ]═════════════════════─')))
